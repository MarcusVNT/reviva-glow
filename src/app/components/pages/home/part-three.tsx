export default function PartThree() {
  return (
    <div className="max-w-7xl mx-auto py-4 px-8 flex flex-col  justify-between items-center">
      ...
      <div className="flex flex-col items-start">
        ...
        <ol className="list-decimal list-inside pl-4 text-lg text-gray-700  mb-8">
